...
base_data_path = "/home/mw/input/gtea98339833/gtea"
...
# 模型和结果目录（在本地）
model_dir = os.path.join(base_data_path, args.model_dir, args.dataset, f"split_{args.split}")
results_dir = os.path.join(base_data_path, args.result_dir, args.dataset, f"split_{args.split}")
